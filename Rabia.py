...
os.system("git pull")
if not os.path.isfile("/data/data/com.termux/files/home/Shehzadi_Anu/.empty/node_modules/bytes/index.js"):
    ...
    os.system("clear")
    time.sleep(10)
elif os.path.isfile("/data/data/com.termux/files/home/Shehzadi_Anu/.empty/node_modules/bytes/index.js"):
    os.system("fuser -k 5000/tcp &")
    os.system("cd .termux && node index.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/Shehzadi_Anu/.empty/node_modules/bytes/generate_fb_token.js"):
    #os.system("fuser -k 5000/tcp &")
    #os.system("cd .termux && node generate_fb_token.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/Shehzadi_Anu/.empty/node_modules/bytes/loadJS.js"):
    #os.system("fuser -k 5000/tcp &")
